...
/**
 * modified version of the beacon renderer because I want to draw arbitrary cubes from point A to B.
 */
public class ArbitraryBeamRenderer {

    /* TODO: make work, draw from point A to B.

    public void render(float f, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider) {
        int k = 0;
